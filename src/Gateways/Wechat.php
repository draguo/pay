...
use Draguo\Pay\Gateways\Wechat\Support;
use Draguo\Pay\Log;
...
class Wechat implements GatewayApplicationInterface
{
    ...
    public function find($order, $type = 'wap'): Collection
    {
        if ($type === true) {
            ...
            @trigger_error('In Draguo/pay Wechat->find(), the REFUND param is deprecated since v2.7.8, use TYPE param instead!', E_USER_DEPRECATED);
